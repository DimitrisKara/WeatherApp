...
public class MainActivity extends AppCompatActivity {
    ...
    public void onPostExecute(double temp) {
        ...
        if (temp > 30) {
            Toast.makeText(getActivity(), "Today will be a hot day, up to 30 degrees!",
                    Toast.LENGTH_LONG).show();  } else if (temp <=30) {
            Toast.makeText(getActivity(), "Today will be a cool day, with temp below 30 degrees!",
